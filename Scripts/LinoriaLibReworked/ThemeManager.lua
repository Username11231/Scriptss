-- тож оптимизированно датабейсом
...
local ThemeManager = {} do
    ...
    local BuiltInThemesList = {};
    do
        for Name in next, ThemeManager.BuiltInThemes do
            BuiltInThemesList[#BuiltInThemesList + 1] = Name;
        end
        table.sort(BuiltInThemesList, function(a, b)
    ...
    function ThemeManager:CreateThemeManager(groupbox)
        ...
        groupbox:AddDivider()
        groupbox:AddDropdown('ThemeManager_ThemeList', { Text = 'Theme list', Values = BuiltInThemesList, Default = 1 })
